...
class BookingApplicationTests {
    ...
    void testCancelNonExistingReservation() {
        ...
        assertThrows(InvalidRequestException.class, () -> bookingController.cancelReservation(10));
    ...
    void testUpdateNonExistingReservation() {
        ...
        LocalDate newReservationStartDate = LocalDate.now().plusDays(1);
        LocalDate newReservationEndDate = newReservationStartDate.plusDays(2);

        //Mocking return of NO reservation
        when(reservationRepository.findById(any())).thenReturn(Optional.empty());
        UpdateRequest updateRequest = new UpdateRequest(1L, newReservationStartDate, newReservationEndDate);

        assertThrows(InvalidRequestException.class, () -> bookingController.reservationUpdate(updateRequest));
